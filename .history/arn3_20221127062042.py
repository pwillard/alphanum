...
if path.is_file():
    ...
    height = parser.get('settings','height')
    width = parser.get('settings','width')  
    fontSize = parser.get('settings','fontSize')
    fontHorz = parser.get('settings','fontHorz')
    fontVert = parser.get('settings','fontVert')
    pathToFont = parser.get('settings','pathToFont')
    fontCOlor = parser.get('settings','fontColor')
else:
