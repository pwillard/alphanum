...
an alpha background for reporting marks.
 The output is a set of TGA files
...
#img = Image.new("RGBA", (1024, 1024), 0, 0, 0))
#img.save("decal.png", "PNG")
...
if __name__ == '__main__':
    ...
    image.save('decal.png', 'png',transparency=0)
    image.close()
    ...
    img1.save("decal1.PNG")
    #os.remove("decal.tga") # remove master working copy
